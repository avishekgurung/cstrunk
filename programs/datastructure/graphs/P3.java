...
class P3{
	public static void main(String args[]){
		...
		for(int i=0;i<g.count;i++){
			System.out.println("Starting Vertex "+g.vertexList[i]);
			g.shortestPath(g.vertexList[i]);
			System.out.println("");
...
/*
	This problem is very very simple, just call the ShortestPathNegativeWeightGraph algorithm(Bellman-Ford)
	algorithm for all the vertices that exists in the graph.
*/